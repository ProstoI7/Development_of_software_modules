...
namespace lab9.ViewModels
{
    public class ContactEditViewModel : ObservableObject, INavigationAware
    {
        ...
        public ContactEditViewModel(
            ...
            PhoneBookDbЛуканина2307б2Context context)
        {
        ...
        private void Save()
        {
            if (_originalContact != null)
            {
                ...
                if (_context.Contacts.Any(c => c.Phone == EditPhone && c.Id != _originalContact.Id))
                {
                ...
                try
                {
                    var dbContact = _context.Contacts.Find(_originalContact.Id);
                    if (dbContact != null)
                    {
